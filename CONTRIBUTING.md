Contributing to LEVIATHAN Coin
============================

The LEVIATHAN Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/leviathan-project/leviathan/blob/master/doc/translation_process.md)
...
The following applies to code changes to the LEVIATHAN Coin project, and is not to be
confused with overall LEVIATHAN Network Protocol consensus changes.

Whether a pull request is merged into LEVIATHAN Coin rests with the project merge
...
Patches that change LEVIATHAN consensus rules are considerably more involved than
...
Where a patchset proposes to change the LEVIATHAN consensus, it must have been
...
The project leader is the release manager for each LEVIATHAN Coin release.
