...
from fake_stake.base_test import LEVIATHAN_FakeStakeTest

class zLVTwrappedSerialsTest(LEVIATHAN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zLVTs..." % DENOM_TO_USE)
