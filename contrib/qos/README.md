...
This means one can have an always-on leviathand instance running, and another local leviathand/leviathan-qt instance which connects to this node and receives blocks from it.
