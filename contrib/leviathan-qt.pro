...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/leviathan-cli.cpp \
           src/leviathan-tx.cpp \
           src/leviathan.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/leviathan.qrc src/qt/leviathan_locale.qrc

TRANSLATIONS += src/qt/locale/leviathan_bg.ts \
                src/qt/locale/leviathan_de.ts \
                src/qt/locale/leviathan_en.ts \
                src/qt/locale/leviathan_es.ts \
                src/qt/locale/leviathan_fi.ts \
                src/qt/locale/leviathan_fr.ts \
                src/qt/locale/leviathan_it.ts \
                src/qt/locale/leviathan_ja.ts \
                src/qt/locale/leviathan_pl.ts \
                src/qt/locale/leviathan_pt.ts \
                src/qt/locale/leviathan_ru.ts \
                src/qt/locale/leviathan_sk.ts \
                src/qt/locale/leviathan_sv.ts \
                src/qt/locale/leviathan_vi.ts \
                src/qt/locale/leviathan_zh_CN.ts \
                src/qt/locale/leviathan_zh_TW.ts
