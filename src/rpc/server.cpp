...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop LEVIATHAN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "LEVIATHAN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LEVIATHAN features */
        {"leviathan", "listmasternodes", &listmasternodes, true, true, false},
        {"leviathan", "getmasternodecount", &getmasternodecount, true, true, false},
        {"leviathan", "masternodeconnect", &masternodeconnect, true, true, false},
        {"leviathan", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"leviathan", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"leviathan", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"leviathan", "masternodecurrent", &masternodecurrent, true, true, false},
        {"leviathan", "masternodedebug", &masternodedebug, true, true, false},
        {"leviathan", "startmasternode", &startmasternode, true, true, false},
        {"leviathan", "createmasternodekey", &createmasternodekey, true, true, false},
        {"leviathan", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"leviathan", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"leviathan", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"leviathan", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"leviathan", "getmasternodescores", &getmasternodescores, true, true, false},
        {"leviathan", "preparebudget", &preparebudget, true, true, false},
        {"leviathan", "submitbudget", &submitbudget, true, true, false},
        {"leviathan", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"leviathan", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"leviathan", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"leviathan", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"leviathan", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"leviathan", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"leviathan", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"leviathan", "checkbudgets", &checkbudgets, true, true, false},
        {"leviathan", "mnsync", &mnsync, true, true, false},
        {"leviathan", "spork", &spork, true, true, false},
        {"leviathan", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> leviathan-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12111/\n";
}
