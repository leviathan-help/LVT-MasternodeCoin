...
static const CAmount OBFUSCATION_POOL_MAX = (999999.99 * COIN);
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 LVT - checking if valid masternode)
