...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("LEVIATHAN Coin"),
     ...
     * override -datadir in the leviathan.conf file in the default data directory
     * (to be consistent with leviathand behavior)
     */
    if (dataDir != getDefaultDataDirectory())
