...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::LVT);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeLEVIATHANAmount"))
        SoftSetArg("-anonymizeleviathanamount", settings.value("nAnonymizeLEVIATHANAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in leviathan.cpp during shotdown to also remove the window positions
