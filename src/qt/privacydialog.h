...
public:
    ...
    void setZLvtControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzLVT_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzLVT_clicked();
    void on_pushButtonZLvtControl_clicked();
