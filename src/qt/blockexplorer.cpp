...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::LVT, nValue);
...
{
    std::string genesisblockhash = "000004900f99b4fd78e6bca52ac0ed79da851aabe1178a2a7218c5d0f4f723aa";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (leviathan.conf).");
            QMessageBox::warning(this, "LEVIATHAN Coin Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#b2242e;}\n a, span { font-family: monospace; }\n span.addr {color:#b2242e; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #b2242e;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#b2242e;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#b2242e;}\n";
