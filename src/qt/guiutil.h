...
/** Utility functions used by the LEVIATHAN Qt UI.
 */
namespace GUIUtil
{
...
// Render LEVIATHAN addresses in monospace font
...
// Parse "leviathan:" URI into recipient object, return true on successful parsing
