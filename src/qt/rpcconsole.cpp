                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzLVTPathCustom = GetArg("-zlvtbackuppath", "");
    ...
    if(!strzLVTPathCustom.empty()) {
        ui->wallet_customzlvtbackuppath->setText(QString::fromStdString(strzLVTPathCustom));
        ui->wallet_customzlvtbackuppath_label->setVisible(true);
        ui->wallet_customzlvtbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzLVTPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the LEVIATHAN RPC console.") + "<br>" +
