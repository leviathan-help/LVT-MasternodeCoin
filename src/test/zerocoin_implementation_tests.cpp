...
#include "key.h"
#include "zlvt/accumulatorcheckpoints.h"
...
BOOST_AUTO_TEST_CASE(deterministic_tests)
{
    ...
    CzLVTWallet zWallet(wallet.strWalletFile);
    ...
    for (int i = 0; i < nTests; i++) {
        ...
        zWallet.GenerateDeterministicZLVT(denom, coin, dMint);
