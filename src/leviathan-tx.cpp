...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LEVIATHAN Coin leviathan-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  leviathan-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded leviathan transaction") + "\n" +
                               "  leviathan-tx [options] -create [commands]   " + _("Create hex-encoded leviathan transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded leviathan transaction
