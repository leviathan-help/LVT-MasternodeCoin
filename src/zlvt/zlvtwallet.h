...
#ifndef LEVIATHAN_ZLVTWALLET_H
#define LEVIATHAN_ZLVTWALLET_H
...
public:
    CzLVTWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLVT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLVT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
