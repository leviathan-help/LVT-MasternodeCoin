...
#ifndef LEVIATHAN_ZLVTTRACKER_H
#define LEVIATHAN_ZLVTTRACKER_H
...
public:
    CzLVTTracker(std::string strWalletFile);
    ~CzLVTTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzLVTWallet* zLVTWallet = NULL);
